...
const TAB_DEFS = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 13.125 8.25 7.5l4.5 4.5 7.5-8.25M3 13.125V18a2.25 2.25 0 0 0 2.25 2.25h13.5A2.25 2.25 0 0 0 21 18v-4.875M15.75 3.75H21v5.25" />
      </svg>
    ),
  },
  {

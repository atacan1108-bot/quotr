 ...
 * in spirit — same teal, same spacing, same table — with zero duplication.
 */
...
export const pdfStyles = StyleSheet.create({
  ...
  brandName:     { fontSize: 17, fontFamily: 'Helvetica-Bold', color: TEAL, marginBottom: 2 },
  brandMeta:     { fontSize: 8.5, color: MUTED, lineHeight: 1.5 },
  headerRule:    { borderBottomWidth: 1.5, borderBottomColor: TEAL, marginBottom: 28 },
  ...
  signedBlock:   { marginTop: 20, borderWidth: 1, borderColor: TEAL, borderRadius: 6, padding: 16 },
  ...
  typedSignature:{ fontSize: 20, fontFamily: 'Helvetica-Oblique', color: TEAL },

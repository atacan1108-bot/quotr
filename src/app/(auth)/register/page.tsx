      ...
      <div className="min-h-screen bg-surface flex flex-col items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm text-center">
          ...
          <p className="text-sm text-muted mb-6">
            ...
            Klik op de link in die mail om je account te activeren, dan kun je inloggen.
          </p>
  ...
  return (
    <div className="min-h-screen bg-surface flex flex-col items-center justify-center px-6 py-12">
      <div className="w-full max-w-sm">
        ...
        <h1 className="text-xl font-semibold text-on-surface mb-1">Account aanmaken</h1>
        <p className="text-sm text-muted mb-8">Gratis aan de slag met professionele offertes</p>
        ...
        <form onSubmit={handleRegister} className="flex flex-col gap-4">
          <div>
            ...
            <input
              ...
              placeholder="Jouw Installatiebedrijf BV"
            />
          </div>
